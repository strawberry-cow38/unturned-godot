...
- [~] **PAUSED the item-system expansion here (~12:18)** — a complete, coherent item + inventory + world loop. New domains (building / vehicles / crafting) are bigger design calls left for master's steer rather than spun up autonomously.
