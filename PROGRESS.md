...
- [ ] **Zombie follow-ups — TODO** — exact per-map outfits (LevelZombies tables, in map files); hats/gear attachment meshes; more Startle/Attack clips (rig has only Startle_0-1 / Attack_0-2, so crawler/sprinter can't use their unique anims); Skull bone-attach for the face (kill the tiny head-bob float); MEGA/SPIRIT/bosses (arena/beacon).
