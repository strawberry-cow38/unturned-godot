...
namespace UnturnedGodot.Net
{
    ...
    public static class NetProtocol
    {
        ...
        public const byte Version = 26; // v26 (faces): SetProfileCommand + the profile block carry the player's FACE (0..31, retail Items/Faces) -- strawberry 2026-09-04 "port player faces"
