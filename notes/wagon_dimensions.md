...
| Side shell ends | Hood nose Z −2.757828, rear gate Z 2.68; outer X ±1.26 from Z −2.32..2.32, taper to ±1.16 at nose/rear bumper | Accepted width and rear taper retained; front nose follows the measured sedan overhang scale. |
| Side wall | Continuous sill at Y −0.12 through both axles; outer skin rises to Y1.00, then to rail Y1.10; inner cabin X ±0.98 | Joined shell with no arch openings, recess returns or interior backing solids. |
...
| Rear gate lower panel | Inner Z2.53, outer Z2.68; top Y1.10; inner lower edge Y0.18; exterior joins bumper at Y0.16 | Joined directly to deck, side walls and bumper; no buried caps. |
| Bumpers | Front X ±1.16, Y−0.158648..0.100803, tip Z−2.90; rear X ±1.16, Y−0.12..0.16, Z2.76..2.90 | Sedan front height levels; rear silhouette retained. Both join the shell. |
...
| All pillar lateral spans | X ±[0.98,1.23] | Shared 0.25 section; bases/roof junctions share edges, with no interior mating caps. |
...
| Belt rails | X ±[0.98,1.23], Y1.10, Z−1.00..2.68; front transition reaches Y1.125 at Z−1.25 | Joined wall top exists between posts; removes buried overlapping rail solids. |
...
| Side front pane | Absolute X=1.226; bottom Z −1.00..0.12 at Y1.10; top Z −0.55..0.12 at Y1.92 | A-to-B aperture; common 0.004 side inset. |
