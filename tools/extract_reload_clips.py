...
# ---- quat helpers (copied from rig_extract for identical root-neutralize math) ----
...
for gun, label in (("eaglefire", "Eaglefire_Reload"), ("maplestrike", "Maplestrike_Reload"), ("masterkey", "Masterkey_Reload")):
    cl = find_reload(gun)
    if not cl:
        print("NO reload for", gun); continue
    c = convert(cl)
    rig["anims"][label] = c
