...
GUID2NAME = {
 ...
 # Yukon's dominant trees: the SNOWY PINES (Pine_2/Pine_3). Yukon's Trees.dat spawns these GUIDs DIRECTLY -- they
 # are the Christmas_Redirect (winter/snow variant) targets that Birch_2/Birch_4 point to. Resolved by MATCHING each
 # GUID to the .dat where it is the METADATA GUID (Bundles\Trees\Pine_2\Pine_2.dat etc.), NOT a substring match --
 # a substring match wrongly found them inside Birch_2/Birch_4.dat as the redirect field (2026-08-12, master caught it).
 "99848480a28f41ebb3d752a47fd5b023":"Pine_2","ba311a4ddbe34121acd6899fd424813b":"Pine_3",
