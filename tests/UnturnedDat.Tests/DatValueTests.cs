...
internal class DatValueTests
{
	...
	public void TryParseInt8(string input, bool expectedSuccess, sbyte expectedValue)
	{
		...
		Assert.AreEqual(expectedSuccess, value.TryParseInt8(out sbyte actualValue));
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseInt8(defaultValue));
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseUInt8(out byte actualValue));
		Assert.AreEqual(expectedValue, actualValue);
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseUInt8(defaultValue));
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseInt16(out short actualValue));
		Assert.AreEqual(expectedValue, actualValue);
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseInt16(defaultValue));
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseUInt16(out ushort actualValue));
		Assert.AreEqual(expectedValue, actualValue);
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseUInt16(defaultValue));
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseInt32(out int actualValue));
		Assert.AreEqual(expectedValue, actualValue);
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseInt32(defaultValue));
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseUInt32(out uint actualValue));
		Assert.AreEqual(expectedValue, actualValue);
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseUInt32(defaultValue));
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseInt64(out long actualValue));
		Assert.AreEqual(expectedValue, actualValue);
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseInt64(defaultValue));
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseUInt64(out ulong actualValue));
		Assert.AreEqual(expectedValue, actualValue);
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseUInt64(defaultValue));
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseFloat(out float actualValue));
		Assert.AreEqual(expectedValue, actualValue);
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseFloat(defaultValue));
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseDouble(out double actualValue));
		Assert.AreEqual(expectedValue, actualValue);
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseDouble(defaultValue));
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseBool(out bool actualValue));
		Assert.AreEqual(expectedValue, actualValue);
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseBool(defaultValue));
	}
	...
	public void TryParseEnumGeneric(string input, bool expectedSuccess, EDatTestEnum expectedValue)
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseEnum(out EDatTestEnum actualValue));
		Assert.AreEqual(expectedValue, actualValue);
	}
	...
	[TestCase("Bear", true, EDatTestEnum.Bear)]
	[TestCase("Dog", true, EDatTestEnum.Dog)]
	[TestCase("Other", false, null)]
	public void TryParseEnumNonGeneric(string input, bool expectedSuccess, object expectedValue)
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseEnum(typeof(EDatTestEnum), out object actualUntypedValue));
		Assert.AreEqual(expectedValue, actualUntypedValue);
	}

	[TestCase("Bear", EDatTestEnum.Bear, EDatTestEnum.Dog)]
	[TestCase("Other", EDatTestEnum.Dog, EDatTestEnum.Dog)]
	public void ParseEnumGeneric(string input, EDatTestEnum expectedValue, EDatTestEnum defaultValue)
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseEnum(defaultValue));
	}

	[TestCase("Bear", EDatTestEnum.Bear, EDatTestEnum.Dog)]
	[TestCase("Other", EDatTestEnum.Dog, EDatTestEnum.Dog)]
	public void ParseEnumNonGeneric(string input, EDatTestEnum expectedValue, EDatTestEnum defaultValue)
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseEnum(typeof(EDatTestEnum), defaultValue));
	}
	...
	public void TryParseGuid(string input, bool expectedSuccess, string expectedValueString)
	{
		...
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseGuid(out System.Guid actualValue));
		Assert.AreEqual(expectedValue, actualValue);
	}
	...
	public void ParseGuid(string input, string expectedValueString, string defaultValueString)
	{
		...
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseGuid(defaultValue));
	}
	...
	public void TryParseDateTimeUtc(string input, bool expectedSuccess, int expectedYear, int expectedMonth, int expectedDay, int expectedHour, int expectedMinute, int expectedSecond)
	{
		...
		Assert.AreEqual(System.DateTimeKind.Utc, expectedValue.Kind, "expectedValue.Kind");
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedSuccess, value.TryParseDateTimeUtc(out System.DateTime actualValue));
		Assert.AreEqual(expectedValue, actualValue);
	...
	public void ParseDateTimeUtc(string input, int expectedYear, int expectedMonth, int expectedDay, int expectedHour, int expectedMinute, int expectedSecond, int defaultYear, int defaultMonth, int defaultDay, int defaultHour, int defaultMinute, int defaultSecond)
	{
		...
		IDatValue value = new DatValue(input);
		System.DateTime actualValue = value.ParseDateTimeUtc(defaultValue);
		Assert.AreEqual(expectedValue, actualValue);
		Assert.AreEqual(System.DateTimeKind.Utc, actualValue.Kind);
	}
	...
	{
		IDatValue value = new DatValue(input);
		Assert.AreEqual(expectedValue, value.ParseType(defaultValue));
	}
}
