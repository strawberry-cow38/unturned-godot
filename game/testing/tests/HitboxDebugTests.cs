...
namespace UnturnedGodot.Testing
{
    ...
    public class HitboxConsoleToggle : GameTest
    {
        ...
        public override IEnumerable<Step> Run()
        {
            ...
            con.DebugRun("hitbox client");   // the real console parse path, not a direct API call
