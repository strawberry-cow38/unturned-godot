...
namespace UnturnedGodot
{
    ...
    public partial class MainMenu : Node3D
    {
        ...
        void BuildUI()
        {
            ...
            // Configuration -> the SAME tabbed Settings screen the pause menu opens (VoX 2026-08-24). It used to
            // open a graphics-only panel, which meant the key binds tab existed but was reachable ONLY from a
            // paused game -- you could not rebind anything before pressing Play.
            MenuButton(layer, "configuration", "Configuration", 350f, false, 3, () => ToggleSettingsPanel());
