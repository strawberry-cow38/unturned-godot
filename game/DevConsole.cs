...
namespace UnturnedGodot
{
    ...
    public partial class DevConsole : CanvasLayer
    {
        ...
        LineEdit _input;
        Label _log;
        static readonly string[] Verbs = { "give", "vehicle", "spawnasset", "holdgun", "teleport", "plant", "skill", "xp", "hold", "deploy", "unarmed", "survival", "toggleGlobalPower", "infFuel", "wear", "unwear", "fluid" };
