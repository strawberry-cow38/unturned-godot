...
namespace UnturnedGodot
{
    ...
    public partial class Vehicle : VehicleBody3D
    {
        ...
        static readonly Spec _semi = new()
        {
            ...
            HeadlightZoneMin = new Vector3(-0.90f, 0.53f, -2.63f), HeadlightZoneMax = new Vector3(-0.72f, 1.35f, -2.33f),   // LEFT headlight BOX (X-0.85..-0.75, Y0.58..1.28, Z-2.58..-2.38); full box so the whole lens glows; inner bound -0.72 stays outboard of the grille (|X|<0.72). right = auto X-mirror (strawberry)
