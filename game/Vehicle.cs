...
namespace UnturnedGodot
{
    ...
    public partial class Vehicle : VehicleBody3D, ITowNode
    {
        ...
        static readonly Spec _sedan = new()
        {
            ...
            SteerPivot = new Vector3(-0.464f, 1.094f, -0.997f), SteerAxis = new Vector3(0f, 0.259f, 0.966f),   // steer centroid + disc normal (PCA); moved with the mesh when the dash went in
            Wheels = new (float, float, float, bool)[]
