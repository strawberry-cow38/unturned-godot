...
namespace UnturnedGodot
{
    ...
    public partial class Viewmodel : Node3D
    {
        ...
        static readonly System.Collections.Generic.Dictionary<string, ScopeC> ScopeCal = new()
        {
            ...
            { "chevron_scope_sight.txt",       new ScopeC(new Vector3( 0f,      -0.300f, -0.0760f), new Vector3( 0f,      -0.110f, -0.0760f), new Vector3( 0f,      -0.4541f, -0.0760f), 22.5f,  0.076f, 12, new Color(0.118f,0.118f,0.118f)) },   // Chevron 12-gon (30,30,30); Z ->optical axis. Lens Y -0.355->-0.300 = nudged toward the muzzle (master)
