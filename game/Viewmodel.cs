...
namespace UnturnedGodot
{
    ...
    public partial class Viewmodel : Node3D
    {
        ...
        static readonly System.Collections.Generic.Dictionary<string, ScopeC> ScopeCal = new()
        {
            ...
            { "cross_scope_sight.txt",         new ScopeC(new Vector3( 0f,      -0.347f, -0.0724f), new Vector3( 0f,      -0.148f, -0.0724f), new Vector3( 0f,      -0.4667f, -0.0724f), 15.0f,  0.107f, 12, new Color(0.118f,0.118f,0.118f)) },   // Cross 12-gon (30,30,30); Z ->optical axis (was -0.056)
