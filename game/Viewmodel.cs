...
namespace UnturnedGodot
{
    ...
    public partial class Viewmodel : Node3D
    {
        ...
        static readonly System.Collections.Generic.Dictionary<string, ScopeC> ScopeCal = new()
        {
            ...
            { "scope_8x_sight.txt",            new ScopeC(new Vector3( 0f,      -0.364f, -0.1086f), new Vector3( 0f,       0.149f, -0.1086f), new Vector3( 0f,      -0.5122f, -0.1086f), 11.25f, 0.136f, 12, new Color(0.118f,0.118f,0.118f)) },   // 8x  (30,30,30)
            { "scope_7x_sight.txt",            new ScopeC(new Vector3( 0f,      -0.364f, -0.0868f), new Vector3( 0f,       0.149f, -0.0868f), new Vector3( 0f,      -0.4893f, -0.0868f), 12.86f, 0.127f, 12, new Color(0.588f,0.588f,0.588f)) },   // 7x  GRAY (150,150,150); lens bumped 0.087->0.112
            { "scope_16x_sight.txt",           new ScopeC(new Vector3( 0f,      -0.364f, -0.1086f), new Vector3( 0f,       0.149f, -0.1086f), new Vector3( 0f,      -0.5122f, -0.1086f),  5.63f, 0.136f, 12, new Color(0.118f,0.118f,0.118f)) },   // 16x (30,30,30)
            { "makeshift_scope_sight.txt",     new ScopeC(new Vector3(-0.0021f, -0.374f, -0.1149f), new Vector3(-0.0021f,  0.120f, -0.1149f), new Vector3(-0.0021f, -0.4705f, -0.1149f), 15.0f,  0.088f,  6, new Color(0.235f,0.235f,0.235f)) },   // Makeshift HEX (60,60,60); a hair wider 0.072->0.078
            { "cross_scope_sight.txt",         new ScopeC(new Vector3( 0f,      -0.347f, -0.0724f), new Vector3( 0f,      -0.148f, -0.0724f), new Vector3( 0f,      -0.4667f, -0.0724f), 15.0f,  0.118f, 12, new Color(0.118f,0.118f,0.118f)) },   // Cross 12-gon (30,30,30); Z ->optical axis (was -0.056)
            { "chevron_scope_sight.txt",       new ScopeC(new Vector3( 0f,      -0.355f, -0.0760f), new Vector3( 0f,      -0.110f, -0.0760f), new Vector3( 0f,      -0.4541f, -0.0760f), 22.5f,  0.084f, 12, new Color(0.118f,0.118f,0.118f)) },   // Chevron 12-gon (30,30,30); Z ->optical axis
            { "shadowstalker_scope_sight.txt", new ScopeC(new Vector3( 0f,      -0.364f, -0.0927f), new Vector3( 0f,       0.149f, -0.0927f), new Vector3( 0f,      -0.4893f, -0.0927f), 15.0f,  0.136f,  4, new Color(0.192f,0.18f,0.2f)) },   // Shadowstalker SQUARE; _Color (0.192,0.18,0.2)
        };
