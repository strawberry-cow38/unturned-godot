...
namespace UnturnedGodot
{
    ...
    public partial class BarricadePlacer : Node3D
    {
        ...
        public bool Aim(Camera3D cam)
        {
            ...
            // BOTH gates, not either/or. This was `CanAttach != null ? CanAttach(...) : DefaultAttachable(...)`,
            // so supplying the structure hook silently DROPPED the no-stacking rule and you could plant a
            // barricade on the face of another barricade. The two answer different questions -- "is this surface
            // a legal thing to build on at all" and "does the structure under it agree" -- and both must hold.
