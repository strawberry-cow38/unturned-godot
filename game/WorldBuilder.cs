...
namespace UnturnedGodot
{
    ...
    public static class WorldBuilder
    {
        ...
        static readonly System.Collections.Generic.Dictionary<string, (string mesh, int table, bool display, string label)> ContainerShelf = new()
        {
            ...
            // CARDBOARD BOXES (master 2026-09-07). Two shapes, two tans -- the four props are IDENTICAL meshes in
            // pairs (0==2, 1==3, vertex for vertex) differing only by a flat material colour, and all four are
            // modelled OPEN with their flaps splayed. There is no closed prop in the game, so the closed state is
            // generated by folding those flaps (tools/make_closed_cardboard.py) and StoreShelf swaps between the two.
            ["2e698a7b85e94c019b3f91ec8796a961"] = ("Cardboard_0", 21, false, "Cardboard Box"),
